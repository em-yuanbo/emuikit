...
var PopLayer = (function (_React$Component) {
  _inherits(PopLayer, _React$Component);

  function PopLayer() {
    _classCallCheck(this, PopLayer);

    _get(Object.getPrototypeOf(PopLayer.prototype), 'constructor', this).apply(this, arguments);
    this.state = { layers: [] };
  ...
  _createClass(PopLayer, [{
    ...
    value: function componentDidMount() {
      var that = this;
      _utils.store.addListener(function () {
        var pops = _utils.store.getState();
    ...
    value: function render() {
      var pops = this.state.layers.map(function (layer, index) {
      ...
      return _react2['default'].createElement(
        'div',
        { className: '' + _styleCss2['default'].poplayer },
        pops,
        tips,
        menus
      );
