  ...
  _createClass(EmInput, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement('input', { ref: 'input2', type: this.props.type || 'text', className: 'input', placeholder: this.props.placeholder, onChange: this.onChange, defaultValue: '' }),
        tip
      );
    }
  }]);
